...
export async function generateNewLyrics(
  ...
  PENTING: Gunakan instruksi vokal panggung/efek khusus ${vocal} HANYA JIKA ada dalam pilihan karakter vokal tersebut. Secara spesifik, jangan masukkan efek 'Vocals Reverb', 'Effect', 'Growl', 'Atmosfer', atau 'Scream' ke dalam deskripsi style musik maupun ke dalam instruksi di sela-sela lirik lagu (seperti tag [Growl] atau [Scream]) KECUALI jika pengguna secara eksplisit memilihnya dalam parameter Karakter Vokal (${vocal}).
